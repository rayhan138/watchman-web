      ...
      >
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Get the ultimate local-first network monitor for Windows and Mac today.
            </motion.p>
            ...
            >
              ...
              <button
                ...
                className="group w-full sm:w-auto flex items-center justify-center gap-3 bg-white text-black px-10 py-4 rounded-full font-bold text-base hover:bg-emerald-400 hover:scale-[1.03] transition-all duration-300 shadow-[0_0_40px_rgba(16,185,129,0.2)]"
              >
                <svg
              ...
              <a
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white/[0.05] backdrop-blur-md text-white border border-white/10 px-10 py-4 rounded-full font-bold text-base hover:bg-white/10 hover:border-white/20 transition-all duration-300"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
