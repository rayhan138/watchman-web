  ...
  const renderTaskbarContent = (isLightMode: boolean, isOverlay: boolean) => (
    <>
      ...
      <div 
        ...
        className={`relative z-10 flex items-center justify-center w-8 h-8 rounded-md transition-colors cursor-pointer mr-1 ${isLightMode ? 'text-black/80' : 'text-white/90'} ${isTrayOpen ? 'bg-[#333333] text-white/90 shadow-inner border border-white/5' : isLightMode ? 'hover:bg-black/5' : 'hover:bg-white/10'}`}
      >
        {isTrayOpen ? (
