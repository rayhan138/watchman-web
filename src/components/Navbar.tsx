  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      <div
        ...
        style={{
          top: isMobile ? "16px" : (inAppTour ? "55px" : scrolled ? "20px" : "36px"), 
          left: (inAppTour && !isMobile) ? "55%" : "50%",
          transform: [
            `translateX(${(inAppTour && !isMobile) ? "0%" : "-50%"})`,
            hidden && !inAppTour ? "translateY(-120%)" : "translateY(0)",
            `scale(${(inAppTour || isMobile) ? 1 : 1.35})` // 35% bigger in Hero on desktop, normal size on mobile or App Tour
          ].join(" "),
      ...
      >
        ...
        {/* ── Mobile Action Group (GitHub + Download + Hamburger) ── */}
        <div className="flex md:hidden items-center gap-2.5 pr-2">
          {/* GitHub Link */}
          <a
            href="https://github.com/rayhan138/Watchman"
            target="_blank"
