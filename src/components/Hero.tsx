...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ── Subtle grid overlay ── */}
      <div
        className="absolute inset-0 pointer-events-none grid-fade opacity-0"
        style={{
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20 items-center w-full">
        ...
        <div>
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <span className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-white/10 bg-white/[0.03] backdrop-blur-md text-neutral-300 text-xs font-semibold tracking-widest uppercase shadow-[0_2px_20px_rgba(255,255,255,0.02)]">
              <svg 
          ...
          >
            <button
              ...
              className="group flex items-center gap-3 bg-white text-black px-7 py-4 rounded-full font-bold text-sm hover:bg-emerald-400 hover:scale-[1.03] transition-all duration-300 shadow-[0_0_40px_rgba(16,185,129,0.15)]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
