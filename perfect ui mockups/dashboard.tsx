      ...
      <div className="watchman-app w-[522px] h-[782px] bg-white border border-[#121212] shadow-2xl flex flex-col text-black overflow-hidden relative select-none shrink-0" style={{ borderRadius: '10px' }}>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-[20px] flex flex-col gap-[16px] relative z-10" style={{ scrollbarWidth: 'none' }}>
          ...
          <div className="flex flex-col gap-[12px]">
            ...
            <div className="rounded-[9999px] border border-[#121212] flex items-center justify-between px-[20px] py-[14px] bg-transparent hover:-translate-y-[2px] hover:bg-white/40 transition-all cursor-default">
              ...
              <div className="flex items-baseline gap-[6px]">
                <span className="watchman-numbers text-[36px] font-[800] tracking-[-1px] leading-none">1.5</span>
            ...
            <div className="rounded-[9999px] border border-[#121212] flex items-center justify-between px-[20px] py-[14px] bg-transparent hover:-translate-y-[2px] hover:bg-white/40 transition-all cursor-default">
              ...
              <div className="flex items-baseline gap-[6px]">
                <span className="watchman-numbers text-[36px] font-[800] tracking-[-1px] leading-none">0.1</span>
                <span className="font-[700] text-[14px] text-[#333333]">KB/s</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-full border border-[#121212] flex items-center px-[20px] py-[12px] gap-[16px] bg-transparent">
            <div className="w-[20px] h-[20px] rounded-full bg-[#10b981] shadow-[0_0_12px_rgba(16,185,129,0.5)] shrink-0"></div>
          ...
          <div className="grid grid-cols-3 gap-[10px]">
            ...
            <div className="rounded-[24px] border border-[#121212] py-[16px] px-[10px] flex flex-col items-center text-center bg-transparent hover:bg-white/40 hover:-translate-y-[2px] transition-all">
              <div className="w-[56px] h-[56px] rounded-full border border-[#121212] flex items-center justify-center mb-[10px] relative overflow-hidden shrink-0">
                 <div className="absolute bottom-0 left-0 right-0 h-[8%]" style={{ background: 'linear-gradient(180deg, rgba(0, 0, 0, 0.02) 0%, rgba(0, 0, 0, 0.10) 100%)' }}></div>
                 <div className="relative z-10 flex items-center">
                    <span className="watchman-numbers font-[800] text-[22px] tracking-[-0.5px]">8</span>
            ...
            <div className="rounded-[24px] border border-[#121212] py-[16px] px-[10px] flex flex-col items-center text-center bg-transparent hover:bg-white/40 hover:-translate-y-[2px] transition-all">
              <div className="w-[56px] h-[56px] rounded-full border border-[#121212] flex items-center justify-center mb-[10px] relative overflow-hidden shrink-0">
                 <div className="absolute bottom-0 left-0 right-0 h-[67%]" style={{ background: 'linear-gradient(180deg, rgba(0, 0, 0, 0.03) 0%, rgba(0, 0, 0, 0.15) 100%)' }}></div>
                 <div className="relative z-10 flex items-center">
                    <span className="watchman-numbers font-[800] text-[22px] tracking-[-0.5px]">67</span>
                    <span className="font-[700] text-[12px]">%</span>
                 </div>
              </div>
              <div className="font-[800] text-[13px] uppercase tracking-[1px] mb-[2px]">RAM</div>
              <div className="font-[700] text-[10px] text-[#333333]">9.3 / 13.9 GB</div>
            </div>
            
            {/* GPU */}
            <div className="rounded-[24px] border border-[#121212] py-[16px] px-[10px] flex flex-col items-center text-center bg-transparent hover:bg-white/40 hover:-translate-y-[2px] transition-all">
              <div className="w-[56px] h-[56px] rounded-full border border-[#121212] flex items-center justify-center mb-[10px] relative overflow-hidden shrink-0">
                 <div className="absolute bottom-0 left-0 right-0 h-[9%]" style={{ background: 'linear-gradient(180deg, rgba(0, 0, 0, 0.04) 0%, rgba(0, 0, 0, 0.20) 100%)' }}></div>
                 <div className="relative z-10 flex items-center">
                    <span className="watchman-numbers font-[800] text-[22px] tracking-[-0.5px]">9</span>
                    <span className="font-[700] text-[12px]">%</span>
                 </div>
              </div>
        ...
        <div className="h-[32px] shrink-0 border-t border-[#121212] flex items-center justify-between px-[16px] text-[10px] font-[700] text-[#333333] relative z-50 bg-transparent uppercase tracking-[1px]">
          ...
          <span className="pt-[1px] watchman-mono">Uptime: 7H 35M</span>
        </div>
      </div>
    </>
  );
